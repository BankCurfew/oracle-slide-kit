...
rule('S17', '[รอยืนยัน', ['iKnow · เครื่องมือวิเคราะห์ความคุ้มครอง', 'เข้า iKYS → iKnow'])  # R8 ①② (③ dropped: iKnow shows no /100)
...
rule('S18', 'จุดที่ลูกค้าอึ้ง', None)  # R8 PENDING: figures from the iKnow frames (writer)
rule('S18', 'แค่ 1-17%', None)  # R8 PENDING
rule('S19', 'iCheck ตอน 3', 'iKnow ตอน 3')
rule('S19', 'ตัวอย่าง:', None)  # R8 PENDING
